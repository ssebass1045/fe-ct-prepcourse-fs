...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   var suma = arrayOfNums.reduce((total , num) => total + num, 0);
   return suma;
...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var sumaNotas = resultadosTest.reduce((total , num) => total + num, 0);
...
function empiezaConNueve(num) {
   ...
   // Tu código:
   const numeroComoString = num.toString();
   return numeroComoString.charAt(0) === '9';
}
